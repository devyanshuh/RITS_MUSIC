...
TAGMES = [ " **𝐇𝐞𝐲 ABDUL 𝐁𝐄𝐓𝐄 𝐊𝐚𝐡𝐚 𝐇𝐨🤗🥱** ",
           ...
           " **𝐓𝐮𝐦𝐡𝐚𝐫𝐢 𝐌𝐮𝐦𝐦𝐲 𝐊𝐲𝐚 𝐊𝐚𝐫 𝐑𝐚𝐡𝐢 𝐇𝐚𝐢 𝐍𝐈𝐓𝐈🤭** ",
           " **𝐦𝐞𝐫𝐞 𝐩𝐚𝐫𝐭𝐧𝐞𝐫 DESTROYER 𝐤𝐨 𝐣𝐚𝐧𝐭𝐞 𝐡𝐨🥺🥺** ",
           ...
           " **𝐍𝐢𝐜𝐞 𝐓𝐨 𝐌𝐞𝐞𝐭 𝐔𝐡☺** ",
           " **𝐇𝐞𝐥𝐥𝐨 🙊 𝐒𝐔𝐍𝐎 WAR SBKAA PAPA 𝐡𝐚𝐢** ",
           " **𝐒𝐭𝐮𝐝𝐲 𝐂𝐨𝐦𝐩𝐥𝐞𝐭𝐞 𝐇𝐮𝐚 𝐃𝐨𝐜𝐭𝐨𝐫 𝐁𝐨𝐲??😺** ",
           " **𝐁𝐨𝐥𝐨 𝐍𝐚 𝐊𝐮𝐜𝐡 𝐥𝐮𝐜𝐢𝐟𝐞𝐫 𝐜𝐡𝐡𝐚𝐤𝐤𝐚🤭** ",
           " **𝐩𝐫𝐞𝐞𝐭𝐢 𝐊𝐨𝐧 𝐇𝐚𝐢...??😅** ",
           ...
           " **𝐀𝐚𝐩 𝐑𝐞𝐥𝐚𝐭𝐢𝐨N𝐬𝐡𝐢𝐩 𝐌𝐞 𝐇𝐨 DARK ..?👀** ",
           " **𝐀𝐁𝐃𝐔𝐋 𝐊𝐢𝐭𝐧𝐚 𝐂𝐡𝐮𝐩 𝐑𝐚𝐡𝐭𝐞 𝐇𝐨 𝐘𝐫𝐫😼** ",
           " **𝐀𝐚𝐩𝐤𝐨 𝐆𝐚𝐧𝐚 𝐆𝐚𝐧𝐞 𝐀𝐚𝐭𝐚 𝐇𝐚𝐢..?😸** ",
           " **𝐆𝐡𝐮𝐦𝐧𝐞 𝐂𝐡𝐚𝐥𝐨𝐠𝐞 𝐂𝐡𝐚𝐧𝐝 𝐏𝐚𝐫 ..??🙈** ",
           " **WARxDESTOYER SBKEE BAAP H ❤‍🔥☠️** ",
           " **𝐇𝐚𝐦 𝐃𝐨𝐬𝐭 𝐁𝐚𝐧 𝐒𝐚𝐤𝐭𝐞 𝐇𝐚𝐢...?🥰** ",
           " **𝐊𝐮𝐜𝐡 𝐁𝐨𝐥 𝐊𝐲𝐮 𝐍𝐡𝐢 𝐑𝐚𝐡𝐞 𝐇𝐨..🥺🥺** ",
           " **𝐊𝐮𝐜𝐡 𝐌𝐞𝐦𝐛𝐞𝐫𝐬 𝐀𝐝𝐝 𝐊𝐚𝐫 𝐃𝐨 🥲** ",
           " **𝐒𝐢𝐧𝐠𝐥𝐞 𝐇𝐨 𝐘𝐚 𝐌𝐢𝐧𝐠𝐥𝐞 😉** ",
           " **𝐀𝐚𝐨 𝐏𝐚𝐫𝐭𝐲 𝐊𝐚𝐫𝐭𝐞 𝐇𝐚𝐢𝐧 𝐚𝐯𝐢𝐤𝐚😋🥳** ",
           " **𝐀𝐁𝐃𝐔𝐋 𝐁𝐡𝐚𝐢 𝐤𝐡𝐚 𝐡𝐨 🧐** ",
           " **𝐌𝐮𝐣𝐡𝐞 𝐁𝐡𝐮𝐥 𝐆𝐲𝐢 𝐧 𝐀𝐌𝐀𝐈𝐑𝐀 🥺** ",
           " **𝐘𝐚𝐡𝐚 𝐀𝐚 𝐉𝐚𝐨:- [ @thala_elclassico_07 ] 𝐌𝐚𝐬𝐭𝐢 𝐊𝐚𝐫𝐞𝐧𝐠𝐞 🤭🤭** ",
           " **𝐓𝐫𝐮𝐭𝐡 𝐀𝐧𝐝 𝐃𝐚𝐫𝐞 𝐊𝐡𝐞𝐥𝐨𝐠𝐞..? 😊** ",
           " **𝐀𝐚𝐣 𝐌𝐮𝐦𝐦𝐲 𝐍𝐞 𝐃𝐚𝐭𝐚 𝐘𝐫🥺🥺** ",
           " **𝐉𝐨𝐢𝐧 𝐊𝐚𝐫 𝐋𝐨:- [ @thala_elclassico_07 ] 🤗** ",
           " **𝐆𝐚𝐥𝐢 𝐬𝐮𝐧 𝐧𝐚 𝐡𝐚𝐢 𝐃𝐄𝐒𝐓𝐑𝐎𝐘𝐄𝐑 𝐤𝐞 𝐩𝐚𝐬𝐬 𝐣𝐚𝐨😗😗** ",
           " **𝐓𝐮𝐦𝐡𝐚𝐫𝐞 𝐃𝐨𝐬𝐭 𝐊𝐚𝐡𝐚 𝐆𝐲𝐞🥺** ",
           " **𝐌𝐲 𝐂𝐮𝐭𝐞 𝐎𝐰𝐧𝐞𝐫 [ @ll_WAR_MN8_ll]🥰** ",
           " **𝐊𝐚𝐡𝐚 𝐊𝐡𝐨𝐲𝐞 𝐇𝐨 DESTROYER 𝐒𝐢𝐫 𝐣𝐢𝐢😜** ",
